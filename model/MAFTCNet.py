...
from model.SwinViT.SwinViT import SwinTransformer_0, SwinTransformer_1, SwinTransformer_2, SwinTransformer_3
import itertools
...
class MAFTCNet(nn.Module):
    ...
    def __init__(
        ...
        self.swinViT_0 = SwinTransformer_0(
        ...
        self.swinViT_1 = SwinTransformer_1(
            in_chans=in_channels,
            embed_dim=feature_size,
            window_size=window_size,
            patch_size=patch_sizes,
        ...
        self.swinViT_2 = SwinTransformer_2(
            in_chans=in_channels,
            embed_dim=feature_size,
            window_size=window_size,
            patch_size=patch_sizes,
    ...
    def forward(self, x_in):
        hidden_states_out_1 = self.swinViT_0(x_in, self.normalize)
        ln_1, ln_2, ln_3 = x_in.shape[2], x_in.shape[2]/2, x_in.shape[2]/4
        L,H = int(ln_1/4),int(ln_1*3/4)
        hidden_states_out_2 = self.swinViT_1(x_in[:,:,L:H,L:H,L:H], self.normalize)
        L,H = int(ln_2/4),int(ln_2*3/4)
        hidden_states_out_3 = self.swinViT_2(x_in[:,:,L:H,L:H,L:H], self.normalize)
        L,H = int(ln_3/4),int(ln_3*3/4)
        hidden_states_out_4 = self.swinViT_3(x_in[:,:,L:H,L:H,L:H], self.normalize)
